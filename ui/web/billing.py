...
def _会計(
    ...
    return (
        ...
        " padding: 12px 16px 10px; margin-bottom: 14px; background: #fff; }"
        ...
        ".billing-amber { color: color-mix(in srgb, var(--warn) 70%, var(--ink)); font-weight: 600; }"
        ...
        " color: color-mix(in srgb, var(--warn) 70%, var(--ink)); margin: 4px 0 6px; }"
